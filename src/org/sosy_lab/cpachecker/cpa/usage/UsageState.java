...
public class UsageState extends AbstractSingleWrapperState implements Targetable {
  ...
  public class UsageStatisticsExitableState extends UsageState implements Exitable {

    private static final long serialVersionUID = 1957118246209506994L;

    private UsageStatisticsExitableState(AbstractState pWrappedElement, UsageState state) {
    ...
    public UsageStatisticsExitableState(UsageState state) {
