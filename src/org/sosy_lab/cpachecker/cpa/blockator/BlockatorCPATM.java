...
public class BlockatorCPATM extends BlockatorCPA implements ConfigurableProgramAnalysisTM {
  public static CPAFactory factory() {
    return AutomaticCPAFactory.forType(BlockatorCPATM.class);
  }
  private ApplyOperator applyOperator;

  public BlockatorCPATM(
      ConfigurableProgramAnalysis pCpa,
      Configuration config,
      LogManager pLogger, CFA pCfa)
      throws InvalidConfigurationException, CPAException {
    super(pCpa, config, pLogger, pCfa);

    if (!(pCpa instanceof ConfigurableProgramAnalysisTM)) {
      throw new IllegalArgumentException("Thread-modular analysis expected");
    }

    applyOperator = new BlockatorApplyOperator(this,
