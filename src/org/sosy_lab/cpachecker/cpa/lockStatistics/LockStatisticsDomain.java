...
public class LockStatisticsDomain implements AbstractDomain
{
  ...
  public boolean isLessOrEqual(AbstractState currentElement, AbstractState reachedElement) {
    return ((LockStatisticsState)currentElement).isLessOrEqual((LockStatisticsState)reachedElement);
  }

  @Override
  public AbstractState join(AbstractState currentElement, AbstractState reachedElement) {
    return ((LockStatisticsState)currentElement).join((LockStatisticsState)reachedElement);
  }
}
