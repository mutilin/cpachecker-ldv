...
public class CoverReducer implements Reducer {
  private final Reducer wrappedReducer;

  public CoverReducer(Reducer pWrappedReducer) {
  ...
  public Precision getVariableExpandedPrecision(Precision pRootPrecision, Block pRootContext,
    ...
    return wrappedReducer.getVariableExpandedPrecision(pRootPrecision, pRootContext, pReducedPrecision);
  }

  @Override
  public Object getHashCodeForState(AbstractState pStateKey, Precision pPrecisionKey) {
    return wrappedReducer.getHashCodeForState(pStateKey, pPrecisionKey);
  }
