...
class FunctionPointerCreateTransferRelation implements TransferRelation {
  ...
  private void getAbstractSuccessorForEdge(
    ...
    if (functionCallVariable != null) {
      ...
      //  }
        ...
        if (fDefNode != null) {
          ...
          FunctionPointerCreateCallEdge callEdge = new FunctionPointerCreateCallEdge(edge.getRawStatement(), lineNumber, predecessorNode, (FunctionDefinitionNode)fDefNode, functionCall, calltoReturnEdge);
    ...
    if (cfaEdge instanceof FunctionPointerCreateReturnEdge) {
      CallToReturnEdge calltoReturnEdge = ((FunctionPointerCreateReturnEdge) cfaEdge).getSummaryEdge();
  ...
  private void handleDeclaration(FunctionPointerCreateState.Builder pNewState, DeclarationEdge declEdge) throws UnrecognizedCCodeException {
  ...
  private void handleStatement(FunctionPointerCreateState.Builder pNewState, IASTStatement pStatement,
  ...
  private void handleFunctionCall(FunctionPointerCreateState.Builder pNewState, FunctionCallEdge callEdge) throws UnrecognizedCCodeException {
  ...
  private void handleReturnStatement(FunctionPointerCreateState.Builder pNewState, IASTExpression returnValue,
      CFAEdge pCfaEdge) throws UnrecognizedCCodeException {
  ...
  private void handleFunctionReturn(FunctionPointerCreateState.Builder pNewState, FunctionReturnEdge pFunctionReturnEdge) throws UnrecognizedCCodeException {
  ...
  private FunctionPointerCreateTarget getValue(IASTRightHandSide exp, FunctionPointerCreateState.Builder element, String function) throws UnrecognizedCCodeException {
    return exp.accept(new ExpressionValueVisitor(element, function, invalidFunctionPointerTarget));
  }

  private static class ExpressionValueVisitor extends DefaultExpressionVisitor<FunctionPointerCreateTarget, UnrecognizedCCodeException>
                                              implements RightHandSideVisitor<FunctionPointerCreateTarget, UnrecognizedCCodeException> {
    ...
    @Override
    public FunctionPointerCreateTarget visit(IASTUnaryExpression pE) {
    ...
    @Override
    public FunctionPointerCreateTarget visit(IASTIdExpression pE) {
      return element.getTarget(scopedIfNecessary(pE, function));
    }

    @Override
    public FunctionPointerCreateTarget visit(IASTCastExpression pE) throws UnrecognizedCCodeException {
      return pE.getOperand().accept(this);
    }

    @Override
    protected FunctionPointerCreateTarget visitDefault(IASTExpression pExp) {
      return UnknownTarget.getInstance();
    }

    @Override
    public FunctionPointerCreateTarget visit(IASTFunctionCallExpression pIastFunctionCallExpression) {
      return UnknownTarget.getInstance();
    }

    @Override
    public FunctionPointerCreateTarget visit(IASTCharLiteralExpression pE) {
      return targetForInvalidPointers;
    }

    @Override
    public FunctionPointerCreateTarget visit(IASTFloatLiteralExpression pE) {
      return targetForInvalidPointers;
    }

    @Override
    public FunctionPointerCreateTarget visit(IASTIntegerLiteralExpression pE) {
      return targetForInvalidPointers;
    }

    @Override
    public FunctionPointerCreateTarget visit(IASTStringLiteralExpression pE) {
      return targetForInvalidPointers;
    }
  }
