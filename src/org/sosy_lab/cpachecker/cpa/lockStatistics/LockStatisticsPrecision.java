...
public class LockStatisticsPrecision implements Precision {
  ...
  public LockStatisticsPrecision(String variableBlacklist, Configuration config) throws InvalidConfigurationException {
    config.inject(this);
   ...
   */
  public LockStatisticsPrecision(LockStatisticsPrecision original) {
