...
class FunctionPointerCreatePrecisionAdjustment implements PrecisionAdjustment {

  private final PrecisionAdjustment wrappedPrecAdjustment;

  public FunctionPointerCreatePrecisionAdjustment(PrecisionAdjustment pWrappedPrecAdjustment) {
  ...
  public Triple<AbstractState, Precision, Action> prec(AbstractState pElement,
    ...
    Preconditions.checkArgument(pElement instanceof FunctionPointerCreateState);
    FunctionPointerCreateState element = (FunctionPointerCreateState)pElement;
