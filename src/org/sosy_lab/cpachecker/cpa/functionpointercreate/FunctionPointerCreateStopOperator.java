...
class FunctionPointerCreateStopOperator implements StopOperator {

  private final StopOperator wrappedStop;

  public FunctionPointerCreateStopOperator(StopOperator pWrappedStop) {
  ...
  public boolean stop(AbstractState pElement,
    ...
    FunctionPointerCreateState fpElement = (FunctionPointerCreateState)pElement;

    for (AbstractState reachedElement : pReached) {
      FunctionPointerCreateState fpReachedElement = (FunctionPointerCreateState)reachedElement;
  ...
  private boolean stop(FunctionPointerCreateState pElement, FunctionPointerCreateState pReachedElement, Precision pPrecision)
                                                      throws CPAException {
