...
public class BoundedRecursionReducer implements Reducer {

  private final Reducer wrappedReducer;

  public BoundedRecursionReducer(Reducer pWrappedReducer) {
  ...
  public Object getHashCodeForState(AbstractState pElementKey, Precision pPrecisionKey) {
    BoundedRecursionState funElement = (BoundedRecursionState)pElementKey;
