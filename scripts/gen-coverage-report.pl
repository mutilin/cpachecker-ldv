...
#This script generates coverage report. It requires .info file, as input.
#You may also specify output directory and original cil-file.

#Input for this script (.info file) is generated by CoverCPA and is located near the verified file.
