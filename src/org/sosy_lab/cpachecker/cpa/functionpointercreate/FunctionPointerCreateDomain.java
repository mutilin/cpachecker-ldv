...
class FunctionPointerCreateDomain implements AbstractDomain {

  private final AbstractDomain wrappedDomain;

  FunctionPointerCreateDomain(AbstractDomain pWrappedDomain) {
  ...
  public boolean isLessOrEqual(AbstractState pElement1, AbstractState pElement2) throws CPAException {
    ...
    FunctionPointerCreateState elem1 = (FunctionPointerCreateState) pElement1;
    FunctionPointerCreateState elem2 = (FunctionPointerCreateState) pElement2;
